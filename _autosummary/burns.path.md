...
`t in [0, 1]` it returns the [`Rect`](burns.rect.md#burns.rect.Rect) viewport at that
...
is a render-time parameter (pass it to [`burns.ken_burns_video()`](burns.md#burns.ken_burns_video) /
[`burns.ken_burns_film()`](burns.md#burns.ken_burns_film)).
