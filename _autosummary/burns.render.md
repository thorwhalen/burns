...
Two entry points, both consuming a [`BurnsPath`](burns.path.md#burns.path.BurnsPath) (the
...
- [`ken_burns_video()`](#burns.render.ken_burns_video) — one image, one `BurnsPath`, one mp4. Dispatches
  to a pluggable backend (see [`burns.backends`](burns.backends.md#module-burns.backends)); the default `"pillow"`
...
Use [`burns.ken_burns_path()`](burns.md#burns.ken_burns_path) (or `BurnsPath.push_in()`) to build paths
